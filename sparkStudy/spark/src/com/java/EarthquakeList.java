...
public class EarthquakeList {
	...
	public static void main(String[] args) {
		...
		SparkSession spark = SparkSession.builder().appName("ClassficationSample")
	            									.master("local[*]")
	            									.getOrCreate();
		...
		Dataset<Row> df = spark.read().format("csv")
	    		...
	    		.load("C:\\Users\\seobi\\Downloads\\earthquakeListTest.csv");
	    df.printSchema();
	    df.show();
...
//		DataFrame df1 = spark.createDataFrame(rdd2, schema);
//		df1.show(false);
//		
